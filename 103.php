...
$data_array=$object-> query("SELECT * FROM `keu_science` where `status`='1'  AND `parent`='' ORDER BY `id`");
//echo "<pre>"; print_r($data_array); echo "</pre>";
if (isset($data_array) AND !empty ($data_array)) {
    ?>
	 <h2 style="color:black; padding-left:100px;"><?php echo $array_frontpage_xml['frontpage_science_name_'.$lang_current]; ?></h2>
	  ...
	  ?>
       <DIV class="cols">
						<div class="view <?php echo "view-".$effect_hover[$i]; ?>">
							<img src="images/science/<?php echo $value['photo']; ?>" />
							<div class="mask">
