...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "science");
$admin_id_module=get_module_id ($MODULES_ARRAY, "science");
...
$datagrid-> query(_TABLE_PREFIX_."science");
$datagrid-> table_field_caption("id", "Номер");
$datagrid-> table_field_caption("order", "Порядок");
$datagrid-> table_field_caption("parent", "Родитель");
$datagrid-> foreign_key ("parent", _TABLE_PREFIX_."science", "name_ru", "id");

$datagrid-> table_field_caption("photo", "Фото");
$datagrid-> convertcolumn_toimage ("photo", "../../images/science/", "50");
