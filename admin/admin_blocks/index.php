...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "admin_blocks");
$admin_id_module=get_module_id ($MODULES_ARRAY, "admin_blocks");
