...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "type_edu");
$admin_id_module=get_module_id ($MODULES_ARRAY, "type_edu"); 

echo "<h4>Тип обучения</h4>";
...
$datagrid-> query(_TABLE_PREFIX_."type_edu");
