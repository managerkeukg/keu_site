...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "corruption");
$admin_id_module=get_module_id ($MODULES_ARRAY, "corruption"); //echo $USER_PERMISSIONS_ARRAY[$admin_id_module];
///echo "<pre>USER MODULE PERMISSIONS "; print_r($USER_PERMISSIONS_ARRAY[$admin_id_module]) ; echo "</pre>";
echo "<h4>Коррупция</h4>";
...
$datagrid-> query(_TABLE_PREFIX_."corruption");
$datagrid-> table_field_caption("id", "Номер");
$datagrid-> table_field_caption("order", "Порядок");
$datagrid-> table_field_caption("photo", "Фото");
$datagrid-> convertcolumn_toimage ("photo", "../../images/corruption/", "50");
