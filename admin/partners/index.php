...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "partners");
$admin_id_module=get_module_id ($MODULES_ARRAY, "partners");
...
$datagrid-> query(_TABLE_PREFIX_."partners");
...
$datagrid-> convertcolumn_toimage ("photo", "../../img/partners/", "50");
