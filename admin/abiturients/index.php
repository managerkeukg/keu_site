...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "abiturients");
$admin_id_module=get_module_id ($MODULES_ARRAY, "abiturients"); //echo $USER_PERMISSIONS_ARRAY[$admin_id_module];
///echo "<pre>USER MODULE PERMISSIONS "; print_r($USER_PERMISSIONS_ARRAY[$admin_id_module]) ; echo "</pre>";
echo "<h4>Абитуриентам</h4>";
...
$datagrid-> query(_TABLE_PREFIX_."abiturients");
$datagrid-> table_field_caption("id", "Номер");
$datagrid-> table_field_caption("order", "Порядок");
$datagrid-> table_field_caption("photo", "Фото");
$datagrid-> convertcolumn_toimage ("photo", "../../images/abit/", "50");
