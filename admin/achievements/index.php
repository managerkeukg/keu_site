...
check_module_user_permission(array ("modules" =>$MODULES_ARRAY, "user_permissions" => $USER_PERMISSIONS_ARRAY), "achievements");
$admin_id_module=get_module_id ($MODULES_ARRAY, "achievements"); //echo $USER_PERMISSIONS_ARRAY[$admin_id_module];

echo "<h4>Достижения</h4>";
...
$datagrid-> query(_TABLE_PREFIX_."achievements");
...
$datagrid-> convertcolumn_toimage ("photo", "../../img/achievements/", "50");
