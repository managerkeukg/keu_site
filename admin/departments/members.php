...
echo "<h4>Контактные лица Кафедр</h4>"; 
...
$datagrid-> query(_TABLE_PREFIX_."members_dep", "AND `department`='$id_subotdel'");
...
$datagrid-> convertcolumn_toimage ("photo", "../../img/contacts_departments/", "50");
