<?php
	...
	$data_array=$object-> query("SELECT `id`, `image_slider` FROM `keu_news` where `status`='1' AND `image_slider`<>'' ORDER BY `id` DESC");
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 900px; height: 300px; overflow: hidden; visibility: hidden; ">
		...
		?>
            <div data-p="112.50" style="display: none;">
                <a href="index.php?show=100&id=<?php echo $value['id'];?>"><img data-u="image" src="img/news/slider/<?php echo $value['image_slider'];?>" /></a>
            </div>
            <!-- <div data-p="112.50" style="display: none;">
