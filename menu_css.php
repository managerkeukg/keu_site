...
#cssmenu > ul {
  ...
  background: -moz-linear-gradient(top, #1D459C 0%, #dddddd 100%);
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #1D459C), color-stop(100%, #dddddd));
  background: -webkit-linear-gradient(top, #1D459C 0%, #dddddd 100%);
  background: -o-linear-gradient(top, #1D459C 0%, #dddddd 100%);
  background: -ms-linear-gradient(top, #1D459C 0%, #dddddd 100%);
  background: linear-gradient(#1D459C 0%, #dddddd 100%);
...
#cssmenu .has-sub ul li:hover > a {
  background: #dddddd;
  color: #ae0001;
  border-color: #1D459C transparent transparent transparent;
}
...
<STYLE>
.lanit-rea-header-top-wrap {
  padding: 8px 0px;
    white-space: nowrap;
}
.lanit-rea-header-nav a {
  color: #fff;
  font-size: 13px;
  text-decoration: none;
}
.lanit-rea-header-nav a:hover {
  text-decoration: none;
}

.lanit-rea-header-top ul, .lanit-rea-header-top ul li {
  display: inline-block;
}

.lanit-rea-header-top-lang {
  padding-right: 10px;
}

.lanit-rea-header-top-lang li a {
  padding: 2px 6px;
}

.lanit-rea-header-top .lanit-rea-header-top-lang-cur {
