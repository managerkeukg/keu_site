...
if (isset($data_array) AND !empty ($data_array)) {
    ?>
	 <h2 style="color:black; padding-left:100px;"><?php echo $array_frontpage_xml['frontpage_students_name_'.$lang_current]; ?></h2>
	  ...
	  ?>
       <DIV class="cols">
						<div class="view <?php echo "view-".$effect_hover[$i]; ?>">
							<img src="images/students/<?php echo $value['photo']; ?>" />
							<div class="mask">
